...
public class EncuestaUsuarioPanelSimple extends javax.swing.JPanel {
        ...
        public EncuestaUsuarioPanelSimple(String usuario, Encuesta encuesta, EncuestasUsuarioFrame frame) {
                initComponents();
        ...
        private void initComponents() {
                ...
                layout.setHorizontalGroup(
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(lblEncuesta, javax.swing.GroupLayout.PREFERRED_SIZE, 931, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        private void btnRespuestasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespuestasActionPerformed
                ...
                new ResultadosEncuestaSimpleFrame(encuesta, usuario).setVisible(true);
                frame.dispose();
