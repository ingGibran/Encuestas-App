...
public class AgregarEncuestaSimpleFrame extends javax.swing.JFrame {
        
        private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AgregarEncuestaSimpleFrame.class.getName());
        ...
        public AgregarEncuestaSimpleFrame() {
                initComponents();
                setLocationRelativeTo(null);
        }
        
        public AgregarEncuestaSimpleFrame(Encuesta encuesta) {
                initComponents();
                setLocationRelativeTo(null);
                ...
                try {
                        ...
                        System.getLogger(AgregarEncuestaSimpleFrame.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        ...
        private void btnFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarActionPerformed
                ...
                if (nombreEncuesta.getText().trim().equals("")) {
                        JOptionPane.showMessageDialog(null, "Ingrese un nombre valido para la encuesta");
                        return;
                }
                ...
                encuesta.setCompleja(false);
                try {
                        encuestaService.addEncuesta(encuesta);
                        
                        for (Pregunta p : preguntas) {
                                p.setId_encuesta( encuestaService.getEncuestaPorNombre( encuesta.getNombre() ).getId_encuesta() );
                                preguntaService.agregarPregunta(p);
                        }
                        
                        JOptionPane.showMessageDialog(null, "Encuesta agregada correctamente");
                        new MenuAdminFrame().setVisible(true);
                        this.dispose();
                } catch (Exception ex) {
                        System.getLogger(AgregarEncuestaSimpleFrame.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        ...
        public void actualizarScrollPreguntas() {
                ...
                for (Pregunta pregunta : preguntas) {
                        PreguntaSimplePanel panel = new PreguntaSimplePanel(indices, pregunta.getTexto(), this);
