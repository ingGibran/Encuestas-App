...
public class CrearCuentaFrame extends javax.swing.JFrame {
        ...
        private static final java.util.logging.Logger logger = java.util.logging.Logger
                        .getLogger(CrearCuentaFrame.class.getName());
        ...
        private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnContinuarActionPerformed
                ...
                OUTER: for (int i = 0; i < email.length(); i++) {
                ...
                // NO hashear aquí - PHP lo hará con password_hash()
                // Crear usuario con contraseña en texto plano
                Usuario user = new Usuario(username, email, false);

                try {
                        // Enviar contraseña en texto plano - PHP la hasheará
                        service.createUsuario(user, password);
                } catch (Exception ex) {
                        System.getLogger(CrearCuentaFrame.class.getName())
                                        .log(System.Logger.Level.ERROR, (String) null, ex);
