...
public class ResultadosEncuestaSimpleFrame extends javax.swing.JFrame {
        
        private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ResultadosEncuestaSimpleFrame.class.getName());
        ...
        public ResultadosEncuestaSimpleFrame(Encuesta encuesta, String usuario) {
                initComponents();
...
System.out.println(encuesta.getId_encuesta() + " - " + usuario);
                ...
                try {
                        ...
                        System.getLogger(ResultadosEncuestaSimpleFrame.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
                }
...
System.out.println(respuesta.getValor());
                        ...
                        RespuestasEncuestaSimplePanel panel = new RespuestasEncuestaSimplePanel(indices, respuesta, this);
