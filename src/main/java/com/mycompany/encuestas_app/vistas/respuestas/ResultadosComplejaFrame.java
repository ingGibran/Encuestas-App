...
public class ResultadosComplejaFrame extends javax.swing.JFrame {
        
        private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ResultadosComplejaFrame.class.getName());
        ...
        public ResultadosComplejaFrame(Encuesta encuesta) {
                initComponents();
        ...
        public void actualizar() {
                ...
                try {
                        for (Usuario u : usuarioService.getAllUsers() ) {
                                if ( respuestaService.getRespuestaPorPreguntaYUsuario( preguntaService.getPreguntasPorEncuesta(encuesta.getId_encuesta()).get(0).getId_pregunta(), u.getId()) != null) {
                                        // Si existe la respuesta del usuario en esa encuesta
                                        ResultadoPanel panel = new ResultadoPanel(u.getId(), encuesta);
