...
public class ResultadosComplejaFrame extends javax.swing.JFrame {
        ...
        private static final java.util.logging.Logger logger = java.util.logging.Logger
                        .getLogger(ResultadosComplejaFrame.class.getName());
        ...
        public void actualizar() {
                ...
                try {
                        java.util.List<modelos.Pregunta> preguntas = preguntaService
                        ...
                        for (Respuesta respuesta : respuestas) {
                                ...
                                if (idUsuario != null && !idUsuario.isEmpty()
                                        ...
                                        java.util.List<Usuario> usuarios = usuarioService.getAllUsers();
