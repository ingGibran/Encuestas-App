...
public class RespuestasEncuestaSimplePanel extends javax.swing.JPanel {
        
        public int indice;
        public Respuesta respuesta;
        public ResultadosEncuestaSimpleFrame frame;
        
        private PreguntaService preguntaService = new PreguntaService();
        

        public RespuestasEncuestaSimplePanel(int indice, Respuesta respuesta, ResultadosEncuestaSimpleFrame frame) {
                initComponents();
                ...
                try {
                        ...
                        System.getLogger(RespuestasEncuestaSimplePanel.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
